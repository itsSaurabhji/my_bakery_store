...
export default function About_Us() {
    ...
    // style="background-image: url(images/background/35.jpg);">
    //  const backgroundImageUrl1 = 'assets/images/background/35.jpg';
    // " style="background-image:url(images/background/34.jpg)"
    const backgroundImageUrl2 = 'assets/images/background/34.jpg';
    // " style="background-image: url(images/background/36.jpg);"
    const backgroundImageUrl3 = 'assets/images/background/36.jpg';
    // " style="background-image: url(images/background/37.jpg);"
    const backgroundImageUrl4 = 'assets/images/background/37.jpg';
    // {{backgroundImageUrl5}}
    const backgroundImageUrl5 = 'assets/images/background/38.jpg';
    // style={{backgroundImageUrl6}}>
    const backgroundImageUrl6 = 'assets/images/background/3.jpg';
    // style="background-image: url(images/background/39.jpg);"
    const backgroundImageUrl7 = 'assets/images/background/39.jpg';
...
{/*Page Title*/}
<section className="page-title" style={{ backgroundImage: `url(${backgroundImageUrl2})` }}
// style={{backgroundImageUrl2}}
>
...
{/** About Section Two **/}
<section className="about-section-two alternate" style={{ backgroundImage: `url(${backgroundImageUrl3})` }}>
    <div className="auto-container">
        ...
        <div className="content-box">
            ...
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse nisi et dolor ornare pellentesque. Nullam porttitor, odio id facilisis dapibus, mauris dolor rhoncus elit, ultricies nulla eros at dui. In suscipit leo sagittis aliquam.
                Integer tristique tempus urna. et pharetra dui urna volutpat elit odio at.</p>
        </div>
        <div className="btn-box text-center">
            <Link to="/" className="theme-btn btn-style-two regular"><span></span>Our Services<span></span></Link>
        </div>
    </div>
</section>
{/**End About Section **/}
...
<div className="features-section style-two">
    <div className="shape_wrapper shape_one">
        <div className="shape_inner shape_two" style={{ backgroundImage: `url(${backgroundImageUrl4})` }}>
...
{/** Chef Section **/}
<section className="chef-section" style={{ backgroundImage: `url(${backgroundImageUrl5})` }}>
    <div className="auto-container">
        <div className="row">
            <div className="content-column col-lg-6 col-md-12 col-sm-12 order-2">
                <div className="inner-column">
                    <div className="content">
                        ...
                        <p>Maria is a Roman-born pastry chef who spent 15 years in his city Rome perfecting his craft and exceptional creations. Vestibulum rhoncus ornare tincidunt. Etiam pretium metus sit amet est aliquet vulputate. Fusce et cursus
                            ligula. Sed accumsan dictum porta. Aliquam rutrum ullamcorper velit hendrerit convallis.</p>
                        <div className="btn-box">
                            <Link to="/" className="theme-btn btn-style-two regular alt"><span></span>Our Services<span></span></Link>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="image-column col-lg-6 col-md-12 col-sm-12">
                <div className="inner-column">
                    <figure className="image"><img src="assets/images/resource/old_man.png" alt=""/></figure>
                </div>
            </div>
        </div>
    </div>
...
<section className="testimonial-section style-two">
    <div className="shape_wrapper shape_one">
        <div className="shape_inner shape_two" style={{ backgroundImage: `url(${backgroundImageUrl6})` }}>
            <div className="overlay"></div>
        </div>
    </div>
...
{/** Our Standards **/}
<section className="our-standards" style={{ backgroundImage: `url(${backgroundImageUrl7})` }}>
    <div className="auto-container">
        <div className="row">
